            ...
            <header className="relative z-10 border-b border-white/10 bg-gray-900/80 px-6 py-4 backdrop-blur-xl">
                <div className="mx-auto flex max-w-4xl items-center justify-between">
                    <div className="flex items-center gap-4">
                        {/* Logo/Icon */}
                        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-indigo-500 to-purple-600 shadow-lg shadow-indigo-500/25">
                            <svg
                ...
                <div className="mx-auto max-w-4xl px-4 py-6">
                    ...
                    {messages.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-16">
                            <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-linear-to-br from-indigo-500 to-purple-600 shadow-2xl shadow-indigo-500/30">
                                <svg
                    ...
                    <div className="space-y-6">
                        ...
                        {isLoading && (
                            <div className="flex items-start gap-4">
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-500 to-cyan-600">
                                    <svg
                                        className="h-5 w-5 text-white"
                                        fill="none"
                                        viewBox="0 0 24 24"
                ...
                <div className="mx-auto max-w-4xl">
                    <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-2 transition focus-within:border-indigo-500/50 focus-within:bg-white/10">
                        ...
                        <button
                            ...
                            className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-r from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-500/25 transition hover:shadow-indigo-500/40 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {isLoading ? (
